...
Pixel PixelShaderFunction(PSInput PS)
{
    ...
    if (depthVal >= depth * 0.99993f)
    {
        ...
        float distFac = saturate(20 / linDist);
		if (distFac > 0.1) Normal = lerp(worldNormalVS, normalize(Normal), sLerpNormal * saturate(20 / linDist));
            else Normal = worldNormalVS;
...
// Techniques
//------------------------------------------------------------------------------------------
technique RTinput_world_norSob
{
    pass P0
    {
