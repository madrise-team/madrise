...
----------------------------------------------------------------------------------------------------------------------------------------------------------
--[[
function sirensRespawner(player, commandName)
 	bindKey(player, "e","down", function()
		local veh = getPedOccupiedVehicle(player)
		removeVehicleSirens(veh)
		addVehicleSirens(veh, 4, 2)
		----------------------------Ford Mustang------------------------
		--setVehicleSirens(veh, 1, 0.45, -0.4, 0.75, 255, 0, 0, 255, 200)
		--setVehicleSirens(veh, 2, -0.45, -0.4, 0.75, 0, 0, 255, 255, 200)
		--setVehicleSirens(veh, 3, 0.2, -0.4, 0.75, 140, 0, 140, 255, 200)
		--setVehicleSirens(veh, 4, -0.2, -0.4, 0.75, 140, 0, 140, 255, 200)
		----------------------------------------------------------------
		-------------------------Lamboghini Aventador-------------------
		--setVehicleSirens(veh, 1, 0.45, -0.05, 0.72, 255, 0, 0, 255, 200)
		--setVehicleSirens(veh, 2, -0.45, -0.05, 0.72, 0, 0, 255, 255, 200)
		--setVehicleSirens(veh, 3, 0.2, -0.05, 0.72, 140, 0, 140, 255, 200)
		--setVehicleSirens(veh, 4, -0.2, -0.05, 0.72, 140, 0, 140, 255, 200)
		----------------------------------------------------------------
		------------------------------Dodge Djip------------------------
		--setVehicleSirens(veh, 1, 0.45, -0.15, 1, 0, 0, 255, 255, 200)
		--setVehicleSirens(veh, 2, -0.45, -0.15, 1, 255, 0, 0, 255, 200)
		--setVehicleSirens(veh, 3, 0.2, -0.15, 1, 140, 0, 140, 255, 200)
		--setVehicleSirens(veh, 4, -0.2, -0.15, 1, 140, 0, 140, 255, 200)
		----------------------------------------------------------------
		---------------------------Dodge Carger-------------------------
		--setVehicleSirens(veh, 1, 0.45, -0.45, 1, 0, 0, 255, 255, 200)
		--setVehicleSirens(veh, 2, -0.45, -0.45, 1, 255, 0, 0, 255, 200)
		--setVehicleSirens(veh, 3, 0.2, -0.45, 1, 140, 0, 140, 255, 200)
		--setVehicleSirens(veh, 4, -0.2, -0.45, 1, 140, 0, 140, 255, 200)
		----------------------------------------------------------------
	end)
end
addCommandHandler("sirensRe", sirensRespawner)
]]
----------------------------------------------------------------------------------------------------------------------------------------------------------