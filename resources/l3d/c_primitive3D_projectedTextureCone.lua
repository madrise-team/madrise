--  					 --
-- file: c_primitive3D_projectedTextureCone.lua					 --
-- version: v1.6					 --
-- author: Ren712					 --
--					 --
-- include: fx/primitive3D_projectedTextureCone.fx, c_common.lua					 --
					 --
local scx,scy = guiGetScreenSize ()					 --
					 --
CPrmTextureProjCone = { }					 --
CPrmTextureProjCone.__index = CPrmTextureProjCone					 --
	 					 --
-- texture, worldPosition Vector3(), elementRotation Vector3(), texSize Vector2(), color Vector4(0-255,0-255,0-255,0-255) 					 --
function CPrmTextureProjCone: create(tex, pos, atten, rot, texSiz, col, isProjPos )					 --
	local scX, scY = guiGetScreenSize()					 --
						 --
	local cShader = {					 --
		shader = DxShader( "fx/primitive3D_projectedTextureCone.fx" ),					 --
		texture = tex,					 --
		textureSize = texSiz,					 --
		projectionFov = 45,					 --
	...
	if cShader.shader then					 --
		...
		return false					 --
					 ...
					 --
function CPrmTextureProjCone: setTesselationByDistance()					 --
		...
		if ( distFromCam < 8 * self.attenuation ) then 					 --
			...
			if self.tessSwitch then					 --
				...
				self.tessSwitch = false					 --
					 ...
					 --
function CPrmTextureProjCone: setObjectTesselation( tess )					 --
	if self.shader then					 --
		self.shapeTess = tess					 --
		self:setTesselationByDistance()					 --
					 ...
					 --
function CPrmTextureProjCone: setBlendAdd( isAddBlend )					 --
	if self.shader then					 --
		if isAddBlend then					 --
			self.destBlend = 2					 --
			...
			self.shader:setValue( "fDestBlend" ,6 )					 --
					 ...
					 --
function CPrmTextureProjCone: setTexture( tex )					 --
	if self.shader then					 --
		self.texture = tex					 --
		self.shader:setValue( "sTexture", tex )					 --
					 ...
					 --
function CPrmTextureProjCone: setTextureSize( texSize )					 --
	if self.shader then					 --
		...
		self.shader:setValue( "sPicSize", texSize.x, texSize.y )					 --
					 ...
					 --
function CPrmTextureProjCone: setTextureFov( fov )					 --
	if self.shader then					 --
		...
		self.shader:setValue( "sProjFov", fov )					 --
					 ...
					 --
function CPrmTextureProjCone: setDistFade( distFade )					 --
	if self.shader then					 --
		...
		self.shader:setValue( "gDistFade", distFade.x, distFade.y )					 --
					 ...
					 --
function CPrmTextureProjCone: setViewMatrix( inMat )					 --
	if self.shader then					 --
		...
		if self.setProjectionPosition then					 --
			...
			self.shader:setValue( "sLightPosition", pos.x, pos.y, pos.z )					 --
					 ...
					 --
function CPrmTextureProjCone: setAutoProjectionSurfaceNormal( nor )					 --
	if self.shader then					 --
		...
		self.shader:setValue( "sSurfaceNormal", nor.x, nor.y, nor.z )					 --
					 ...
					 --
function CPrmTextureProjCone: setAutoProjectionEnabled( isAutoProj )					 --
	if self.shader then					 --
		...
		self.shader:setValue( "bProjectionPosition", self.setProjectionPosition )					 --
					 ...
					 --
function CPrmTextureProjCone: setAutoProjectionSearchLength( serLen )					 --
	if self.shader then					 --
		self.projectionPositionSearchLength = serLen					 --
	end					 --
end					 --
					 --
function CPrmTextureProjCone: setPosition( pos )					 --
	if self.shader then					 --
		self.position = Vector3(pos.x, pos.y, pos.z)					 --
		self.shader:setValue( "sLightPosition", pos.x, pos.y, pos.z )					 --
	end					 --
					 ...
					 --
function CPrmTextureProjCone: setAttenuation( atten )					 --
	if self.shader then					 --
		...
		self:setTesselationByDistance()					 --
					 ...
					 --
function CPrmTextureProjCone: setAttenuationPower( attenPow )					 --
	if self.shader then					 --
		...
		self.shader:setValue( "sLightAttenuationPower", attenPow )					 --
					 ...
					 --
function CPrmTextureProjCone: setSurfaceAttenuation( atten )					 --
	if self.shader then					 --
		...
		self.shader:setValue( "sSurfaceAttenuation", atten )					 --
					 ...
					 --
function CPrmTextureProjCone: setSurfaceAttenuationPower( attenPow )					 --
	if self.shader then					 --
		...
		self.shader:setValue( "sSurfaceAttenuationPower", attenPow )					 --
					 ...
					 --
function CPrmTextureProjCone: setSurfaceOffset( surOffs )					 --
	if self.shader then					 --
		...
		self.shader:setValue( "sSurfaceOffset", surOffs )					 --
					 ...
					 --
function CPrmTextureProjCone: setRotation( rot )					 --
	if self.shader then					 --
		self.rotation = Vector3(rot.x, rot.y, rot.z),					 --
		self.shader:setValue( "sLightRotation", math.rad(rot.x), math.rad(rot.y), math.rad(rot.z) )					 --
	end					 --
					 ...
					 --
function CPrmTextureProjCone: setColor( col )					 --
	if self.shader then					 --
		...
		self.shader:setValue( "sLightColor", col.x / 255, col.y / 255, col.z / 255, col.w/ 255 )					 --
					 ...
					 --
function CPrmTextureProjCone: getObjectToCameraAngle()					 --
	if self.position then					 --
		...
		return false					 --
					 ...
					 --
function CPrmTextureProjCone: getDistanceFromViewAngle( inAngle )					 --
	if self.shader then					 --
		...
		return false					 --
					 ...
					 --
function CPrmTextureProjCone: draw()					 --
	if self.shader then					 --
		...
		if ( distFromCam < clipDist ) then						 --
			...
			dxDrawMaterialPrimitive3D( "trianglestrip", self.shader, false, unpack( self.trianglestrip ) )						 --
        					 ...
        					 --
function CPrmTextureProjCone: destroy()					 --
	if self.shader then					 --
		self.shader:destroy()					 --
		self.shader = nil					 --
	end					 --
