--  					 --
-- file: c_primitive3D_projectedTextureCubeNoNRM.lua					 --
-- version: v1.6					 --
-- author: Ren712					 --
--					 --
-- include: fx/primitive3D_projectedTextureCubeNoNRM.fx, c_common.lua					 --
					 --
local scx,scy = guiGetScreenSize ()					 --
					 --
CPrmTextureProjCubeNoNRM = { }					 --
CPrmTextureProjCubeNoNRM.__index = CPrmTextureProjCubeNoNRM					 --
					 --
-- texture, worldPosition Vector3(), elementRotation Vector3(), texSize Vector2(), color Vector4(0-255,0-255,0-255,0-255) 					 --
function CPrmTextureProjCubeNoNRM: create(tex, pos, atten, rot, col )					 --
	local scX, scY = guiGetScreenSize()					 --
						 --
	local cShader = {					 --
		shader = DxShader( "fx/primitive3D_projectedTextureCubeNoNRM.fx" ),					 --
		texture = tex,					 --
	...
	if cShader.shader then					 --
		...
		return false					 --
					 ...
					 --
function CPrmTextureProjCubeNoNRM: setTesselationByDistance()					 --
		...
		if ( distFromCam < 8 * self.attenuation ) then 					 --
			...
			if self.tessSwitch then					 --
				...
				self.tessSwitch = false					 --
					 ...
					 --
function CPrmTextureProjCubeNoNRM: setObjectTesselation( tess )					 --
	if self.shader then					 --
		self.shapeTess = tess					 --
		self:setTesselationByDistance()					 --
					 ...
					 --
function CPrmTextureProjCubeNoNRM: setBlendAdd( isAddBlend )					 --
	if self.shader then					 --
		if isAddBlend then					 --
			self.destBlend = 2					 --
			...
			self.shader:setValue( "fDestBlend" ,6 )					 --
					 ...
					 --
function CPrmTextureProjCubeNoNRM: setTexture( tex )					 --
	if self.shader then					 --
		self.texture = tex					 --
		self.shader:setValue( "sCubeTexture", tex )					 --
					 ...
					 --
function CPrmTextureProjCubeNoNRM: setDistFade( distFade )					 --
	if self.shader then					 --
		...
		self.shader:setValue( "gDistFade", distFade.x, distFade.y )					 --
					 ...
					 --
function CPrmTextureProjCubeNoNRM: setPosition( pos )					 --
	if self.shader then					 --
		...
		self.shader:setValue( "sLightPosition", pos.x, pos.y, pos.z )					 --
					 ...
					 --
function CPrmTextureProjCubeNoNRM: setAttenuation( atten )					 --
	if self.shader then					 --
		...
		self:setTesselationByDistance()					 --
					 ...
					 --
function CPrmTextureProjCubeNoNRM: setAttenuationPower( attenPow )					 --
	if self.shader then					 --
		...
		self.shader:setValue( "sLightAttenuationPower", attenPow )					 --
					 ...
					 --
function CPrmTextureProjCubeNoNRM: setRotation( rot )					 --
	if self.shader then					 --
		...
		self.shader:setValue( "sLightRotation", math.rad(rot.x), math.rad(rot.y), math.rad(rot.z) )					 --
					 ...
					 --
function CPrmTextureProjCubeNoNRM: setRotationSpeed( rotSpeed )					 --
	if self.shader then					 --
		...
		self.shader:setValue( "sLightRotationSpeed", rotSpeed.x, rotSpeed.y, rotSpeed.z )					 --
					 ...
					 --
function CPrmTextureProjCubeNoNRM: setColor( col )					 --
	if self.shader then					 --
		...
		self.shader:setValue( "sLightColor", col.x / 255, col.y / 255, col.z / 255, col.w/ 255 )					 --
					 ...
					 --
function CPrmTextureProjCubeNoNRM: getObjectToCameraAngle()					 --
	if self.position then					 --
		...
		return false					 --
					 ...
					 --
function CPrmTextureProjCubeNoNRM: getDistanceFromViewAngle( inAngle )					 --
	if self.shader then					 --
		...
		return false					 --
					 ...
					 --
function CPrmTextureProjCubeNoNRM: draw()					 --
	if self.shader then					 --
		...
		if ( distFromCam < clipDist ) then						 --
			...
			dxDrawMaterialPrimitive3D( "trianglestrip", self.shader, false, unpack( self.trianglestrip ) )						 --
        					 ...
        					 --
function CPrmTextureProjCubeNoNRM: destroy()					 --
	if self.shader then					 --
		self.shader:destroy()					 --
		self.shader = nil					 --
	end					 --
