--  					 --
-- file: c_primitive3D_projectedTextureConeNoDB.lua					 --
-- version: v1.6					 --
-- author: Ren712					 --
--					 --
-- include: fx/primitive3D_projectedTextureConeNoDB.fx, c_common.lua					 --
					 --
local scx,scy = guiGetScreenSize ()					 --
					 --
CPrmTextureProjConeNoDB = { }					 --
CPrmTextureProjConeNoDB.__index = CPrmTextureProjConeNoDB					 --
	 					 --
-- texture, worldPosition Vector3(), elementRotation Vector3(), texSize Vector2(), color Vector4(0-255,0-255,0-255,0-255) 					 --
function CPrmTextureProjConeNoDB: create(tex, pos, atten, rot, texSiz, col, isProjPos )					 --
	local scX, scY = guiGetScreenSize()					 --
						 --
	local cShader = {					 --
		shader = DxShader( "fx/primitive3D_projectedTextureConeNoDB.fx" ),					 --
		texture = tex,					 --
		textureSize = texSiz,					 --
		projectionFov = 45,					 --
	...
	if cShader.shader then					 --
		...
		return false					 --
					 ...
					 --
					 --
function CPrmTextureProjConeNoDB: setObjectTesselation( tess )					 --
	-- for compatibility					 --
end					 --
					 --
function CPrmTextureProjConeNoDB: setBlendAdd( isAddBlend )					 --
	if self.shader then					 --
		if isAddBlend then					 --
			self.destBlend = 2					 --
			...
			self.shader:setValue( "fDestBlend" ,6 )					 --
					 ...
					 --
function CPrmTextureProjConeNoDB: setTexture( tex )					 --
	if self.shader then					 --
		self.texture = tex					 --
		self.shader:setValue( "sTexture", tex )					 --
					 ...
					 --
function CPrmTextureProjConeNoDB: setTextureSize( texSize )					 --
	if self.shader then					 --
		...
		self.shader:setValue( "sPicSize", texSize.x, texSize.y )					 --
					 ...
					 --
function CPrmTextureProjConeNoDB: setTextureFov( fov )					 --
	if self.shader then					 --
		...
		self.shader:setValue( "sProjFov", fov )					 --
					 ...
					 --
function CPrmTextureProjConeNoDB: setDistFade( distFade )					 --
	if self.shader then					 --
		...
		self.shader:setValue( "gDistFade", distFade.x, distFade.y )					 --
					 ...
					 --
function CPrmTextureProjConeNoDB: setViewMatrix( inMat )					 --
	if self.shader then					 --
		...
		if self.setProjectionPosition then					 --
			...
			self.shader:setValue( "sLightPosition", pos.x, pos.y, pos.z )					 --
					 ...
					 --
function CPrmTextureProjConeNoDB: setAutoProjectionSurfaceNormal( nor )					 --
	if self.shader then					 --
		...
		self.shader:setValue( "sSurfaceNormal", nor.x, nor.y, nor.z )					 --
					 ...
					 --
function CPrmTextureProjConeNoDB: setAutoProjectionEnabled( isAutoProj )					 --
	if self.shader then					 --
		...
		self.shader:setValue( "bProjectionPosition", self.setProjectionPosition )					 --
					 ...
					 --
function CPrmTextureProjConeNoDB: setAutoProjectionSearchLength( serLen )					 --
	if self.shader then					 --
		self.projectionPositionSearchLength = serLen					 --
	end					 --
end					 --
					 --
function CPrmTextureProjConeNoDB: setPosition( pos )					 --
	if self.shader then					 --
		self.position = Vector3(pos.x, pos.y, pos.z)					 --
		self.shader:setValue( "sLightPosition", pos.x, pos.y, pos.z )					 --
	end					 --
					 ...
					 --
function CPrmTextureProjConeNoDB: setAttenuation( atten )					 --
	if self.shader then					 --
		...
		self.shader:setValue( "sLightAttenuation", atten )					 --
					 ...
					 --
function CPrmTextureProjConeNoDB: setAttenuationPower( attenPow )					 --
	if self.shader then					 --
		...
		self.shader:setValue( "sLightAttenuationPower", attenPow )					 --
					 ...
					 --
function CPrmTextureProjConeNoDB: setSurfaceAttenuation( atten )					 --
	if self.shader then					 --
		...
		self.shader:setValue( "sSurfaceAttenuation", atten )					 --
					 ...
					 --
function CPrmTextureProjConeNoDB: setSurfaceAttenuationPower( attenPow )					 --
	if self.shader then					 --
		...
		self.shader:setValue( "sSurfaceAttenuationPower", attenPow )					 --
					 ...
					 --
function CPrmTextureProjConeNoDB: setSurfaceOffset( surOffs )					 --
	if self.shader then					 --
		...
		self.shader:setValue( "sSurfaceOffset", surOffs )					 --
					 ...
					 --
function CPrmTextureProjConeNoDB: setRotation( rot )					 --
	if self.shader then					 --
		self.rotation = Vector3(rot.x, rot.y, rot.z),					 --
		self.shader:setValue( "sLightRotation", math.rad(rot.x), math.rad(rot.y), math.rad(rot.z) )					 --
	end					 --
					 ...
					 --
function CPrmTextureProjConeNoDB: setColor( col )					 --
	if self.shader then					 --
		...
		self.shader:setValue( "sLightColor", col.x / 255, col.y / 255, col.z / 255, col.w/ 255 )					 --
					 ...
					 --
function CPrmTextureProjConeNoDB: getObjectToCameraAngle()					 --
	if self.position then					 --
		...
		return false					 --
					 ...
					 --
function CPrmTextureProjConeNoDB: getDistanceFromViewAngle( inAngle )					 --
	if self.shader then					 --
		...
		return false					 --
					 ...
					 --
function CPrmTextureProjConeNoDB: draw()					 --
	if self.shader then					 --
		...
		if ( distFromCam < clipDist ) then					 --
			...
			dxDrawMaterialPrimitive3D( "trianglestrip", self.shader, false, unpack( self.trianglestrip ) )						 --
        					 ...
        					 --
function CPrmTextureProjConeNoDB: destroy()					 --
	if self.shader then					 --
		self.shader:destroy()					 --
		self.shader = nil					 --
	end					 --
