--  					 --
-- file: c_primitive3D_projectedTextureNoNRM.lua					 --
-- version: v1.6					 --
-- author: Ren712					 --
--					 --
-- include: fx/primitive3D_projectedTextureNoNRM.fx, c_common.lua					 --
					 --
local scx,scy = guiGetScreenSize ()					 --
					 --
CPrmTextureProjNoNRM = { }					 --
CPrmTextureProjNoNRM.__index = CPrmTextureProjNoNRM					 --
	 					 --
-- texture, worldPosition Vector3(), elementRotation Vector3(), texSize Vector2(), color Vector4(0-255,0-255,0-255,0-255) 					 --
function CPrmTextureProjNoNRM: create(tex, pos, atten, rot, texSiz, col, isProjPos )					 --
	local scX, scY = guiGetScreenSize()					 --
						 --
	local cShader = {					 --
		shader = DxShader( "fx/primitive3D_projectedTextureNoNRM.fx" ),					 --
		texture = tex,					 --
		textureSize = texSiz,					 --
	...
	if cShader.shader then					 --
		...
		return false					 --
					 ...
					 --
function CPrmTextureProjNoNRM: setTesselationByDistance()					 --
		...
		if ( distFromCam < 8 * self.attenuation ) then 					 --
			...
			if self.tessSwitch then					 --
				...
				self.tessSwitch = false					 --
					 ...
					 --
function CPrmTextureProjNoNRM: setObjectTesselation( tess )					 --
	if self.shader then					 --
		self.shapeTess = tess					 --
		self:setTesselationByDistance()					 --
					 ...
					 --
function CPrmTextureProjNoNRM: setBlendAdd( isAddBlend )					 --
	if self.shader then					 --
		if isAddBlend then					 --
			self.destBlend = 2					 --
			...
			self.shader:setValue( "fDestBlend" ,6 )					 --
					 ...
					 --
function CPrmTextureProjNoNRM: setTexture( tex )					 --
	if self.shader then					 --
		self.texture = tex					 --
		self.shader:setValue( "sTexture", tex )					 --
					 ...
					 --
function CPrmTextureProjNoNRM: setTextureSize( texSize )					 --
	if self.shader then					 --
		...
		self.shader:setValue( "sPicSize", texSize.x, texSize.y )					 --
					 ...
					 --
function CPrmTextureProjNoNRM: setDistFade( distFade )					 --
	if self.shader then					 --
		...
		self.shader:setValue( "gDistFade", distFade.x, distFade.y )					 --
					 ...
					 --
function CPrmTextureProjNoNRM: setViewMatrix( inMat )					 --
	if self.shader then					 --
		...
		if self.setProjectionPosition then					 --
			...
			self.shader:setValue( "sLightPosition", pos.x, pos.y, pos.z )					 --
					 ...
					 --
function CPrmTextureProjNoNRM: setAutoProjectionSurfaceNormal( nor )					 --
	if self.shader then					 --
		...
		self.shader:setValue( "sSurfaceNormal", nor.x, nor.y, nor.z )					 --
					 ...
					 --
function CPrmTextureProjNoNRM: setAutoProjectionEnabled( isAutoProj )					 --
	if self.shader then					 --
		...
		self.shader:setValue( "bProjectionPosition", self.setProjectionPosition )					 --
					 ...
					 --
function CPrmTextureProjNoNRM: setAutoProjectionSearchLength( serLen )					 --
	if self.shader then					 --
		self.projectionPositionSearchLength = serLen					 --
	end					 --
end					 --
					 --
function CPrmTextureProjNoNRM: setPosition( pos )					 --
	if self.shader then					 --
		self.position = Vector3(pos.x, pos.y, pos.z)					 --
		self.shader:setValue( "sLightPosition", pos.x, pos.y, pos.z )					 --
	end					 --
					 ...
					 --
function CPrmTextureProjNoNRM: setAttenuation( atten )					 --
	if self.shader then					 --
		...
		self:setTesselationByDistance()					 --
					 ...
					 --
function CPrmTextureProjNoNRM: setAttenuationPower( attenPow )					 --
	if self.shader then					 --
		...
		self.shader:setValue( "sLightAttenuationPower", attenPow )					 --
					 ...
					 --
function CPrmTextureProjNoNRM: setSurfaceAttenuation( atten )					 --
	if self.shader then					 --
		...
		self.shader:setValue( "sSurfaceAttenuation", atten )					 --
					 ...
					 --
function CPrmTextureProjNoNRM: setSurfaceAttenuationPower( attenPow )					 --
	if self.shader then					 --
		...
		self.shader:setValue( "sSurfaceAttenuationPower", attenPow )					 --
					 ...
					 --
function CPrmTextureProjNoNRM: setSurfaceOffset( surOffs )					 --
	if self.shader then					 --
		...
		self.shader:setValue( "sSurfaceOffset", surOffs )					 --
					 ...
					 --
function CPrmTextureProjNoNRM: setRotation( rot )					 --
	if self.shader then					 --
		self.rotation = Vector3(rot.x, rot.y, rot.z),					 --
		self.shader:setValue( "sLightRotation", math.rad(rot.x), math.rad(rot.y), math.rad(rot.z) )					 --
	end					 --
					 ...
					 --
function CPrmTextureProjNoNRM: setColor( col )					 --
	if self.shader then					 --
		...
		self.shader:setValue( "sLightColor", col.x / 255, col.y / 255, col.z / 255, col.w/ 255 )					 --
					 ...
					 --
function CPrmTextureProjNoNRM: getObjectToCameraAngle()					 --
	if self.position then					 --
		...
		return false					 --
					 ...
					 --
function CPrmTextureProjNoNRM: getDistanceFromViewAngle( inAngle )					 --
	if self.shader then					 --
		...
		return false					 --
					 ...
					 --
function CPrmTextureProjNoNRM: draw()					 --
	if self.shader then					 --
		...
		if ( distFromCam < clipDist ) then						 --
			...
			dxDrawMaterialPrimitive3D( "trianglestrip", self.shader, false, unpack( self.trianglestrip ) )						 --
        					 ...
        					 --
function CPrmTextureProjNoNRM: destroy()					 --
	if self.shader then					 --
		self.shader:destroy()					 --
		self.shader = nil					 --
	end					 --
