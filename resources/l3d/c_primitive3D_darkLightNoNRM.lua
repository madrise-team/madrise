-- 					 --
-- file: c_primitive3D_darkLightNoNRM.lua					 --
-- version: v1.6					 --
-- author: Ren712					 --
--					 --
-- include: fx/primitive3D_darkLightNoNRM.fx, c_common.lua					 --
					 --
local scx,scy = guiGetScreenSize ()					 --
					 --
CPrmLightDarkNoNRM = { }					 --
CPrmLightDarkNoNRM.__index = CPrmLightDarkNoNRM					 --
	 					 --
-- worldPosition Vector3() , attenuation Vector1(0-n), color Vector4(0-255,0-255,0-255,0-255) 					 --
function CPrmLightDarkNoNRM: create(pos, atten, col )					 --
	local scX, scY = guiGetScreenSize()					 --
						 --
	local cShader = {					 --
		shader = DxShader( "fx/primitive3D_darkLightNoNRM.fx" ),					 --
	...
	if cShader.shader then					 --
		...
		return false					 --
					 ...
					 --
function CPrmLightDarkNoNRM: setTesselationByDistance()					 --
		...
		if ( distFromCam < 4 * self.attenuation ) then 					 --
			...
			if self.tessSwitch then					 --
				...
				self.tessSwitch = false					 --
					 ...
					 --
function CPrmLightDarkNoNRM: setTesselationSwitchDistance( tessDis )					 --
	if self.shader then					 --
		...
		self:setTesselationByDistance()					 --
					 ...
					 --
function CPrmLightDarkNoNRM: setObjectTesselation( tess )					 --
	if self.shader then					 --
		self.shapeTess = tess					 --
		self:setTesselationByDistance()					 --
	end					 --
					 ...
					 --
function CPrmLightDarkNoNRM: setDistFade( distFade )					 --
	if self.shader then					 --
		...
		self.shader:setValue( "gDistFade", distFade.x, distFade.y )					 --
					 ...
					 --
function CPrmLightDarkNoNRM: setPosition( pos )					 --
	if self.shader then					 --
		...
		self.shader:setValue( "sLightPosition", pos.x, pos.y, pos.z )					 --
					 ...
					 --
function CPrmLightDarkNoNRM: setAttenuation( atten )					 --
	if self.shader then					 --
		...
		self:setTesselationByDistance()					 --
					 ...
					 --
function CPrmLightDarkNoNRM: setAttenuationPower( attenPow )					 --
	if self.shader then					 --
		...
		self.shader:setValue( "sLightAttenuationPower", attenPow )					 --
					 ...
					 --
function CPrmLightDarkNoNRM: setColor( col )					 --
	if self.shader then					 --
		...
		self.shader:setValue( "sLightColor", col.x / 255, col.y / 255, col.z / 255, col.w/ 255 )					 --
					 ...
					 --
function CPrmLightDarkNoNRM: getObjectToCameraAngle()					 --
	if self.position then					 --
		...
		return false					 --
					 ...
					 --
function CPrmLightDarkNoNRM: getDistanceFromViewAngle( inAngle )					 --
	if self.shader then					 --
		...
		return false					 --
					 ...
					 --
function CPrmLightDarkNoNRM: draw()					 --
	if self.shader then					 --
		...
		if ( distFromCam < clipDist ) then						 --
			...
			dxDrawMaterialPrimitive3D( "trianglestrip", self.shader, false, unpack( self.trianglestrip ) )						 --
        					 ...
        					 --
function CPrmLightDarkNoNRM: destroy()					 --
	if self.shader then					 --
		self.shader:destroy()					 --
		self.shader = nil					 --
	end					 --
