...
engineApplyShaderToWorldTexture(shader, 'sw_dirt01_forestblend')
...
function()
shader = dxCreateShader('shader.fx')
terrain = dxCreateTexture('img/leans.png')
dxSetShaderValue(shader, 'gTexture', terrain)
...
engineApplyShaderToWorldTexture(shader, 'hiwayoutside_256')
engineApplyShaderToWorldTexture(shader, 'desgrns256')
end
)
...
function()
shader = dxCreateShader('shader.fx')
terrain = dxCreateTexture('img/loolll.png')
dxSetShaderValue(shader, 'gTexture', terrain)
...
-- function()
-- shader = dxCreateShader('shader.fx')
-- terrain = dxCreateTexture('img/image02222.jpg')
-- dxSetShaderValue(shader, 'gTexture', terrain)
...
engineApplyShaderToWorldTexture(shader, 'sf_backaley1')
...
engineApplyShaderToWorldTexture(shader, 'elm_treegrn')
engineApplyShaderToWorldTexture(shader, 'cedar1')
engineApplyShaderToWorldTexture(shader, 'cedar2')
end
)
--
addEventHandler('onClientResourceStart', resourceRoot,
...
engineApplyShaderToWorldTexture(shader, 'girder2_red_64hv')
...
function()
shader = dxCreateShader('shader.fx')
terrain = dxCreateTexture('img/bild.jpg')
dxSetShaderValue(shader, 'gTexture', terrain)
engineApplyShaderToWorldTexture(shader, 'kaccdepot_256')
engineApplyShaderToWorldTexture(shader, 'victim_bboard')
engineApplyShaderToWorldTexture(shader, 'semi3dirty')
engineApplyShaderToWorldTexture(shader, 'homies_1')
engineApplyShaderToWorldTexture(shader, 'heat_04')
engineApplyShaderToWorldTexture(shader, 'vgsn_emerald')
engineApplyShaderToWorldTexture(shader, 'vgnammuwal2')
end
)
...
engineApplyShaderToWorldTexture(shader, 'monobloc_256128')
engineApplyShaderToWorldTexture(shader, 'ws_carparknew2b')
engineApplyShaderToWorldTexture(shader, 'concretedust2_256128')
...
engineApplyShaderToWorldTexture(shader, 'desertgravel256')
end
)
...
function()
shader = dxCreateShader('shader.fx')
terrain = dxCreateTexture('img/bloods.png')
dxSetShaderValue(shader, 'gTexture', terrain)
